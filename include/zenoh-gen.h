...
typedef enum z_encoding_prefix_t {
  Z_ENCODING_PREFIX_T_EMPTY = 0,
  Z_ENCODING_PREFIX_T_APP_OCTET_STREAM = 1,
  Z_ENCODING_PREFIX_T_APP_CUSTOM = 2,
  Z_ENCODING_PREFIX_T_TEXT_PLAIN = 3,
  Z_ENCODING_PREFIX_T_APP_PROPERTIES = 4,
  Z_ENCODING_PREFIX_T_APP_JSON = 5,
  Z_ENCODING_PREFIX_T_APP_SQL = 6,
  Z_ENCODING_PREFIX_T_APP_INTEGER = 7,
  Z_ENCODING_PREFIX_T_APP_FLOAT = 8,
  Z_ENCODING_PREFIX_T_APP_XML = 9,
  Z_ENCODING_PREFIX_T_APP_XHTML_XML = 10,
  Z_ENCODING_PREFIX_T_APP_X_WWW_FORM_URLENCODED = 11,
  Z_ENCODING_PREFIX_T_TEXT_JSON = 12,
  Z_ENCODING_PREFIX_T_TEXT_HTML = 13,
  Z_ENCODING_PREFIX_T_TEXT_XML = 14,
  Z_ENCODING_PREFIX_T_TEXT_CSS = 15,
  Z_ENCODING_PREFIX_T_TEXT_CSV = 16,
  Z_ENCODING_PREFIX_T_TEXT_JAVASCRIPT = 17,
  Z_ENCODING_PREFIX_T_IMAGE_JPEG = 18,
  Z_ENCODING_PREFIX_T_IMAGE_PNG = 19,
  Z_ENCODING_PREFIX_T_IMAGE_GIF = 20,
} z_encoding_prefix_t;
